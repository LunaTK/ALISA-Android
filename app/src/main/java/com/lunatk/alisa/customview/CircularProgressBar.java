...
public class CircularProgressBar extends AppCompatImageView {
    ...
    public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircularProgressBar_cmp_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircularProgressBar_cmp_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.CircularProgressBar_cmp_border_overlay, DEFAULT_BORDER_OVERLAY);
        mDrawAntiClockwise = a.getBoolean(R.styleable.CircularProgressBar_cmp_draw_anticlockwise, DEFAULT_DRAW_ANTI_CLOCKWISE);
        mFillColor = a.getColor(R.styleable.CircularProgressBar_cmp_fill_color, DEFAULT_FILL_COLOR);
        mInnrCircleDiammeter = a.getFloat(R.styleable.CircularProgressBar_cmp_centercircle_diammterer, DEFAULT_INNTER_DAIMMETER_FRACTION);
        mProgressColor = a.getColor(R.styleable.CircularProgressBar_cmp_progress_color, DEFAULT_PROGRESS_COLOR);
        mBaseStartAngle = a.getFloat(R.styleable.CircularProgressBar_cmp_progress_startAngle, 0);
        ...
        gestureListener = new GestureDetector(context, new GestureDetector.OnGestureListener() {
            ...
            public boolean onDown(MotionEvent motionEvent) {
                if (computeInArea(motionEvent.getX(), motionEvent.getY())) {
                    ...
                    if (onChangeListener != null) {
                        onChangeListener.onClick(CircularProgressBar.this);
                    }
                    postInvalidate();
                    return true;
            ...
            public void onLongPress(MotionEvent motionEvent) {
                if (onChangeListener != null) {
                    onChangeListener.onLongPress(CircularProgressBar.this);
                }
            }
