...
//        public static final String IP = "172.30.1.19";
    public static final int PORT = 9949;

    public static final int FLUSH_REQUEST_PERIOD = 10 * 1000;//milli second
    public static final int BLE_SCAN_PERIOD = 10 * 60 * 1000; //스캔 주기
    public static final int BLE_SCAN_TIME = 10 * 1000; // 스캔 진행 시간
